...
void showHelp(const QCommandLineParser& parser, Command cmd)
{
    ...
    if (cmd == Command::None || cmd == Command::Help) {
        ...
        out << QCoreApplication::translate("CLI",
            ...
            "  export-snbx     Export notebooks to .3EN projects (portable backup)\n"
            "  import          Import .3EN projects or legacy .3enotes/.snbx packages\n"
        ...
        out << QCoreApplication::translate("CLI",
            ...
            "\n"
            "Export notebooks to .3EN projects (portable backup format).\n"
            "\n"
            "ARGUMENTS:\n"
            "  <input>...              Notebook paths (.snb folders) or directories\n"
            "\n"
            ...
            "\n"
            "NOTE: .3EN projects can be imported on any device with 3ENotes; legacy .3enotes/.snbx is also supported.\n");
    } else if (cmd == Command::Import) {
        // Import help
        out << QCoreApplication::translate("CLI",
            "Usage: speedynote import [OPTIONS] <input>... -d <dest>\n"
            "\n"
            "Import .3EN projects or legacy .3enotes/.snbx packages.\n"
            "\n"
            "ARGUMENTS:\n"
            "  <input>...              .3EN/.3enotes/.snbx files or directories containing them\n"
            "\n"
            "OUTPUT OPTIONS:\n"
            ...
            "\n"
            "DISCOVERY OPTIONS:\n"
            "  --recursive             Search directories recursively for .3EN/.3enotes/.snbx files\n"
            "\n"
            "COMMON OPTIONS:\n"
            "  --verbose               Show detailed progress\n"
            "  --json                  Output results as JSON\n"
            ...
            "  speedynote import ~/Backup/*.3EN -d ~/Notes/ --dry-run\n"
            "\n"
